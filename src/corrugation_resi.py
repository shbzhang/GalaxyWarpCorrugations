...
if __name__ == '__main__':
	...
	fig, ax = plt.subplots(nrows=3, ncols=5, sharex=True, sharey=True, figsize=(figwidth, figwidth*0.7))
	...
	for i in range(len(theta_sep)-2):
		...
		#ax[i].scatter(starR[starIdx], starZZ[starIdx], s=1, c='red', zorder=9)#, **rad_kws_mc)
