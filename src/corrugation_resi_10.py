...
if __name__ == '__main__':
	...
	if i==10:
		### plot cloud
		ax.scatter(rr[idx], zz[idx], s=scatter_size[idx]*5, **rad_kws_mc)
		...
		ax.text(0.02, 0.95, text, transform=ax.transAxes, **rad_kws_text)
		...
		#ax.tick_params(top=True, right=True, direction='in')#, labelsize=1000/self.dpi)
		#ax.tick_params(which='minor', top=True, right=True, direction='in')#, labelsize=1000/self.dpi)
